package com.droid.smart_staff.newsapp.blogs.adapters
...
import com.example.newsapp.databinding.RowBlogsItemBindingBinding


internal class BlogsAdapter(
    private var selectedNews: ArrayList<NewsDataItem>,
    private var context: Context,
    private var mOnSelectedListenerCallback: OnBlogsSelectedListenerCallback
) :
    RecyclerView.Adapter<BlogsAdapter.NewsItemViewHolder>() {

    inner class NewsItemViewHolder(private val newsBinding: RowBlogsItemBindingBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NewsItemViewHolder {
        val newsBinding = RowBlogsItemBindingBinding.inflate(
...
interface OnBlogsSelectedListenerCallback {
